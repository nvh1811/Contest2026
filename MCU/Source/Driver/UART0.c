...
* Note			: None
*****************************************************************************/
void UART0_DMASizeSet(uint32_t wDMASize)
{
	SN_UART0->DMA_b.DMA_SIZE = wDMASize;
}

/*****************************************************************************
* Function		: UART0_DMAEnable
...
{
	SN_UART0->DMA |= mskUART_DMAEN_EN;
}

/*****************************************************************************
* Function		: UART0_DMADisable
...
{
	SN_UART0->DMA = mskUART_DMAEN_DIS;
}
