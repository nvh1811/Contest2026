#ifndef __SN32F400_UART_H
#define __SN32F400_UART_H
...
/*** DMA Mode register************/
#define	UART_DMAEN_EN						1		
#define	UART_DMAEN_DIS					0

#define	mskUART_DMAEN_EN				(UART_DMAEN_EN << 22)		
#define	mskUART_DMAEN_DIS				(UART_DMAEN_DIS << 22)
...
void UART0_DMASizeSet(uint32_t);
void UART0_DMAEnable(void);
void UART0_DMADisable(void);
...
void UART1_DMASizeSet(uint32_t);
void UART1_DMAEnable(void);
void UART1_DMADisable(void);

#endif	/*__SN32F400_UART_H*/
